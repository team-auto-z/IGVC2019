...
geometry_msgs::Pose imudata[3];//posearray
...
/*IMU**********/
    ...
    imudata[0].position.x =ax1; 
    imudata[0].position.y =ay1; 
    imudata[0].position.z =az1; 
    
    ///PUBLISHING VALUES OF gyroscope
    imudata[1].position.x =gx1; 
    imudata[1].position.y =gy1; 
    imudata[1].position.z =gz1; 
    
    ///PUBLISHING VALUES OF EULER ANGLES (YPR)
    imudata[2].position.x =yaw; 
    imudata[2].position.y =pitch; 
    imudata[2].position.z =roll; 
    //publishing normalised quaternion on imudata(0)
    imudata[0].orientation.x = q[0];  
    imudata[0].orientation.y = q[1]; 
    imudata[0].orientation.z = q[2]; 
    imudata[0].orientation.w = q[3];  
